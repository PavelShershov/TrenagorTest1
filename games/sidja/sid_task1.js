...
// Задача: "Какое максимальное количество фишек может срубить за один ход красный игрок? (без дополнительного хода)" (Сиджа 7×7)
(() => {
    ...
    // Возвращает количество срубленных фишек и список
