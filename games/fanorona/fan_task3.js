...
(() => {
    ...
    // ---------- 7. Отрисовка чёрной нумерации на всех фишках ----------
    ...
    // ---------- 8. Генератор задачи "Уязвимые фишки" ----------
    function generateVulnerabilityTask(maxAttempts = 500) {
        ...
        for (let attempt = 0; attempt < maxAttempts; attempt++) {
            ...
            // Варианты ответа: отдельные checkbox-значения от 1 до N
            ...
            return {
                ...
                // Чёрная нумерация на всех фишках
                green_numbers: numbers,

                // Чтобы глазик не накладывал номера клеток поверх номеров фишек
                skipPositionNumbers: Object.keys(numbers).map(Number),

                // Подсказочное поле для интерфейсов, если понадобится ограничение
